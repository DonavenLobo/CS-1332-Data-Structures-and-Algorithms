 ...
 * @version 1.3
 *
 * This JUnit file maybe be updated to include String Test conditions to test the Sorting algorithms.
 *
...
public class RudreshPatelSortingTest {
    ...
    public void lsdRadixSort11() {
        // min value edge case
        int[] unsortedArray = new int[]{ -2000, 1000, 4000, 3000, (Integer.MIN_VALUE * -1), -1000, 8000, 9000};
        int[] sortedArray = new int[]{(Integer.MIN_VALUE * -1), -2000, -1000, 1000, 3000, 4000, 8000, 9000};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
